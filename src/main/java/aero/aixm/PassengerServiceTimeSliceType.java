    ...
    extends AbstractAIXMTimeSliceType
{
    ...
    public List<PassengerServiceTimeSliceType.Extension> getExtension() {
        if (extension == null) {
            extension = new ArrayList<PassengerServiceTimeSliceType.Extension>();
        }
    ...
    public static class Extension {
        ...
        @XmlElementRef(name = "AbstractPassengerServiceExtension", namespace = "http://www.aixm.aero/schema/5.1", type = JAXBElement.class, required = false)
