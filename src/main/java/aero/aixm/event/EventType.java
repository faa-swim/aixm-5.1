 ...
 *       &lt;sequence>
 *         &lt;element name="timeSlice" type="{http://www.aixm.aero/schema/5.1/event}EventTimeSlicePropertyType" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends AbstractAIXMFeatureType
{
    ...
    protected List<EventTimeSlicePropertyType> timeSlice;
     ...
     * {@link EventTimeSlicePropertyType }
     * 
     * 
     */
    public List<EventTimeSlicePropertyType> getTimeSlice() {
        if (timeSlice == null) {
            timeSlice = new ArrayList<EventTimeSlicePropertyType>();
        }
